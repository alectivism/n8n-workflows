# LinkedIn Posts → personal-website (weekly)

Weekly cron that syncs recent LinkedIn posts to a JSON feed. The workflow behind the activity feed on alecfoster.com.
