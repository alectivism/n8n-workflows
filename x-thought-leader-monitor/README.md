...
Weekly cron that pulls posts from a roster of X accounts, scores each for relevance with an LLM, and files keepers to Notion.

## How it works

- **Trigger:** schedule (cron) — `0 0 11 * * 5`
- **Nodes:** 11
