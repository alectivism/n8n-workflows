# Content Pipeline: News & Web Articles Monitor

Weekly cron over a dozen industry news and blog feeds, LLM-filtered for relevance, written to Notion.

## How it works

- **Trigger:** schedule (cron) — `0 0 7 * * 5`
- **Nodes:** 13
